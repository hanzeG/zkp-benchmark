    ...
    <main>
      <Box mb={20}>
        <Flex>
          ...
          <HStack p={3}>
            <ColorModeSwitcher />
            <Button as='a' href='https://x.com/home' target='_blank' size='sm' background='blackAlpha.900' color='white' _hover={{ background: 'blackAlpha.800' }} _active={{ background: 'blackAlpha.700' }} colorScheme='white'>
              <HStack>
            ...
            <Button as='a' href='https://github.com/hanzeG/zklib_circom/tree/main' target='_blank' size='sm' background='blackAlpha.900' color='white' _hover={{ background: 'blackAlpha.800' }} _active={{ background: 'blackAlpha.700' }} colorScheme='white'>
              <HStack>
                <Image width={20} src={g} alt='Github Logo' />
                <Text>Github</Text>
              </HStack>
            </Button>
            {/* <Box>
        ...
        <Box p={4}>
          <Stack spacing={10}>
            <Box p={2}>
              <Center>
                <Stack spacing={4}>
                  <Center>
                    <HStack>
                      {/* <Image width={50} height={50} alt='zk-hash' src={logo} /> */}
                      <Heading as='h1' fontWeight={700} fontFamily={rounded.style.fontFamily}>ZK-Hash</Heading>
                    </HStack>
                  </Center>
                  <Stack>
                    ...
                    {/* <Heading as='h3' fontSize='md' textAlign='center' fontWeight='normal'>(if it’s not fair, <Link as='a' href='https://github.com/hanzeG/zklib_circom/tree/main' target='_blank' color={useColorModeValue('blue.600', 'blue.200')}>raise a PR!</Link>)</Heading> */}
                  </Stack>
                  {/* <Center>
            ...
            {/* <Center>
                  <Button as='a' href='https://x.com/home' target='_blank' size='lg' background='blackAlpha.900' color='white' _hover={{ background: 'blackAlpha.800' }} _active={{ background: 'blackAlpha.700' }} colorScheme='white'>
                    <HStack>
